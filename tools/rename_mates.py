...
# FOR THE AI AGENT
def rename_mates(rename_mapping: Dict[str, str]) -> str:
    """
    ...
    try:
        # Initialize renamer
        robot_dir = "robots/stable-wheel-legged"
        ...
        try:
            ...
            from main import main as run_onshape_converter

            # Run the converter with the robot directory
            run_onshape_converter(robot_dir)
