#!/usr/bin/env python3
"""
Read mate names from robot JSON files as a function_tool.
"""
...
@function_tool
async def read_mates(robot_name: str) -> str:
    """
    ...
    Args:
        robot_name: The name of the robot to read mates from (e.g., "folding-mechanism")
