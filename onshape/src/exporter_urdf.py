...
from onshape.src.robot import Joint, Link, Part, Robot
...
class ExporterURDF(Exporter):
    ...
    def build(self, robot: Robot):
        ...
        self.append("<!-- Generated using Placeholder agent system -->")
        if self.config:
        ...
        if len(robot.base_links) > 1:
            ...
            print(("Only the first base link will be considered."))
